...
function processItem(item, myUser, myDevice, excludeZeroDevices, extracted) {
    var _a;
    ...
    if (Array.isArray(deviceListNode === null || deviceListNode === void 0 ? void 0 : deviceListNode.content)) {
        (_a = deviceListNode === null || deviceListNode === void 0 ? void 0 : deviceListNode.content) === null || _a === void 0 ? void 0 : _a.forEach(({ tag, attrs }) => {
            processDevice(tag, attrs, user, myUser, myDevice, excludeZeroDevices, extracted);
        });
    }
}
function processDevice(tag, attrs, user, myUser, myDevice, excludeZeroDevices, extracted) {
